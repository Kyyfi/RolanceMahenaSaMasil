...
ShopTab:AddToggle("Auto 3x Get YingYang Crystal (BETA)", false, function(Value)
    autoTwinBirdies = Value
    task.spawn(function()
        while autoTwinBirdies do
            pcall(function()
                openCrystalRemote:InvokeServer("openCrystal", "YingYang Crystal", 3, true)
            end)
            task.wait(0.1)
        end
    end)
...
SunsetAtmosphere.Color=Color3.fromRGB(255,150,100)
SunsetAtmosphere.Decay=Color3.fromRGB(255,120,80)
SunsetAtmosphere.Glare=0.6
...
RunService.Stepped:Connect(function()
    ...
    SunsetColorCorrection.TintColor=Color3.fromRGB(255,180+math.sin(timeOffset*0.5)*20,120+math.cos(timeOffset*0.3)*15)
