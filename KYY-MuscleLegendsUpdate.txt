...
local function createWhitelistGUI()
    ...
    spawn(function()
        ...
        if isWhitelisted() then
            statusLabel.Text = "✅ Whitelisted: " .. player.Name
