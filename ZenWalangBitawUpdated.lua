...
local windowTitle = "🔴 Haa??? 🔴| Welcome " .. LocalPlayer.DisplayName
...
-- 3. ANTI-AFK SWITCH (Elerium v2 UI Library Edition - Non-Draggable & Extra Large Rainbow)
local Players = game:GetService("Players")
...
MainFrame.Size = UDim2.new(0, 500, 0, 80) -- Pinalawak pa lalo (500) para kasya ang buong "ANTI AFK:" text nang hindi napuputol
MainFrame.Position = UDim2.new(0.5, -250, 0.00, 0) -- Naka-center sa taas ng screen
...
-- DAMBUHALANG Rainbow Text Label (ANTI AFK Text)
local TextLabel = Instance.new("TextLabel")
TextLabel.Size = UDim2.new(1, 0, 1, 0)
TextLabel.BackgroundTransparency = 1
TextLabel.Text = "ANTI AFK: 00:00:00" -- GINAWANG "ANTI AFK:" ANG TEXT
        ...
        if not AFKTimerThread then
            AFKTimerThread = task.spawn(function()
                ...
                while true do
                    ...
                    -- Ina-update ang text habang pinapanatili ang "ANTI AFK:" prefix
...
mainTab:AddLabel("Secret Void Crystal")

-- The specific sellPet remote script wrapped inside an AddSwitch loop
mainTab:AddSwitch("Auto Sell Dual Dynasty Dogs", function(state)
...
-- The specific sellPet remote script wrapped inside an AddSwitch loop
mainTab:AddSwitch("Auto Sell Dual Chaos Birdies", function(state)
    getgenv().AutoSell = state
